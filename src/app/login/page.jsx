  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 pt-14">
      <div className="w-full max-w-sm">
        <div className="mb-8">
          <h1 className="text-xl font-semibold text-zinc-100 tracking-tight mb-1">Log in to DevHub</h1>
          <p className="text-[13px] text-zinc-500">Enter your credentials to continue.</p>
        </div>
